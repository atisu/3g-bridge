...
namespace dlmgr
{
	...
	{
	public:
		static CSTR_C DLRequested;    //DLEvent
		static CSTR_C DLFinished;     //JobEvent
		static CSTR_C DLFailed;       //JobEvent
	};

	typedef events::WrapperEventData<const DLException *> DLEventData;
}
